...
@Ds(entity = CustomerGroup.class, sort = {@SortField(field = CustomerGroup_Ds.f_code)})
@RefLookups({
		@RefLookup(refId = CustomerGroup_Ds.f_paymentMethodId, namedQuery = DocType.NQ_FIND_BY_CODE, params = {@Param(name = "code", field = CustomerGroup_Ds.f_paymentMethod)}),
		@RefLookup(refId = CustomerGroup_Ds.f_paymentTermId, namedQuery = PaymentTerm.NQ_FIND_BY_NAME, params = {@Param(name = "name", field = CustomerGroup_Ds.f_paymentTerm)})})
public class CustomerGroup_Ds extends AbstractTypeWithCodeDs<CustomerGroup> {
	...
	public CustomerGroup_Ds() {
		super();
	}

	public CustomerGroup_Ds(CustomerGroup e) {
		super(e);
	}
