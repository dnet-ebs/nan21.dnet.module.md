...
@Ds(entity = ProductAccountType.class, sort = {@SortField(field = ProductAccountType_Ds.f_code)})
public class ProductAccountType_Ds
		extends
			AbstractTypeWithCodeDs<ProductAccountType> {
	...
	public ProductAccountType_Ds() {
		super();
	}

	public ProductAccountType_Ds(ProductAccountType e) {
		super(e);
	}
