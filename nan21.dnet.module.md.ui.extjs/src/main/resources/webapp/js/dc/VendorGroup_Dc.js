 ...
 */
Ext.define(Dnet.ns.md + "VendorGroup_Dc" , {
	extend: "dnet.core.dc.AbstractDc",
	recordModel: Dnet.ns.md + "VendorGroup_Ds"
});

/* ================= FILTER FORM: Filter ================= */			

Ext.define(Dnet.ns.md + "VendorGroup_Dc$Filter" , {
	extend: "dnet.core.dc.view.AbstractDcvFilterForm",
	alias: "widget.md_VendorGroup_Dc$Filter",
...
Ext.define(Dnet.ns.md + "VendorGroup_Dc$EditList" , {
	extend: "dnet.core.dc.view.AbstractDcvEditableGrid",
	alias: "widget.md_VendorGroup_Dc$EditList",
