...
Ext.define(Dnet.ns.md + "ProductCategory_Ui" , {
	...
	_defineElements_: function() {
		...
		.addDcFormView("categ", {name:"categView", width:200, xtype:"md_ProductCategory_Dc$ViewIcon"})
	...
	_linkElements_: function() {
		this._getBuilder_()
		.addChildrenTo("main", ["categFilter", "categEditList", "categView"], ["north", "center", "east"])
